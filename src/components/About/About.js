...
{/* <Link className="subnav_links" path="/about" component={About} ><h3>About</h3></Link>
          <Link className="subnav_links" path="/about/history" component={History} ><h3>History</h3></Link>
          <Link className="subnav_links" path="/about/contact" component={Contact} ><h3>Contact</h3></Link> */}